...
export function ConfiguracoesPage({ onFechar }: Props) {
  ...
  async function alterarSenha() {
    ...
    try {
      ...
      setSenhaErro(error instanceof Error ? error.message : "Erro ao alterar senha.");
    } finally {
  ...
  const senhaValida = senhaAtual.length > 0 && novaSenha.length >= 6 && novaSenha === confirmarSenha;
