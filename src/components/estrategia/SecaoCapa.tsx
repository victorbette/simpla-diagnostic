      ...
      <div style={{ ...CARD, border: "0.5px solid #E5E7EB" }}>
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          {logoBase64 ? (
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <img src={logoBase64} alt="Logo" style={{ height: 48, objectFit: "contain", borderRadius: 6, border: "1px solid #BFDBFE", padding: 4 }} />
              <button
            ...
            <div
              ...
              style={{
                border: "2px dashed #BFDBFE", borderRadius: 8, padding: "20px 0",
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <input
            ...
            style={{
              width: "100%", padding: "8px 12px", borderRadius: 6, border: "1px solid #BFDBFE",
        ...
        <div>
          ...
          <textarea
            ...
            style={{
              ...
              border: "1px solid #BFDBFE", fontSize: 13, color: "#000000",
      ...
      <div style={{ ...CARD, border: "0.5px solid #E5E7EB" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 20 }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 22, fontWeight: 700, color: "#000000", margin: 0 }}>{score}<span style={{ fontSize: 14, color: "#6B7280" }}>/100</span></p>
          </div>
          <div>
            <p style={{ fontSize: 11, color: "#6B7280", margin: "0 0 4px", textTransform: "uppercase", fontWeight: 600 }}>Patrimônio Financeiro</p>
            <p style={{ fontSize: 16, fontWeight: 700, color: "#1E40AF", margin: 0 }}>{formatCurrency(patrimonio)}</p>
          </div>
          <div>
        ...
        <div style={{ borderTop: "1px solid #F0F7FF", paddingTop: 16 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
            {[
              { label: "Asset Alloc.", color: "#000000", bg: "#DBEAFE" },
        ...
        <div style={{ marginTop: 16, padding: "12px 14px", backgroundColor: "#F0F7FF", borderRadius: 8, fontSize: 13, color: "#111827" }}>
