    ...
    <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <FerramentaPGBL
        ...
        savedResult={resultadoFiscal ? {
          ...
          irRetidoFonte:          resultadoFiscal.irRetidoFonte,
          saldoSemPGBL:           resultadoFiscal.saldoSemPGBL,
          saldoComPGBL:           resultadoFiscal.saldoComPGBL,
          inputRendaAnualBruta:   resultadoFiscal.inputRendaAnualBruta,
          inputInssPago:          resultadoFiscal.inputInssPago,
          inputDespesasMedicas:   resultadoFiscal.inputDespesasMedicas,
          inputDespesasInstrucao: resultadoFiscal.inputDespesasInstrucao,
          inputPensaoAlimenticia: resultadoFiscal.inputPensaoAlimenticia,
          inputDependentes:       resultadoFiscal.inputDependentes,
          inputAporteAnualPGBL:   resultadoFiscal.inputAporteAnualPGBL,
          inputIrRetidoFonte:     resultadoFiscal.inputIrRetidoFonte,
        ...
        onSave={(r) => {
          onResultadoFiscal({
            ...
            irRetidoFonte:          r.irRetidoFonte,
            saldoSemPGBL:           r.saldoSemPGBL,
            saldoComPGBL:           r.saldoComPGBL,
            inputRendaAnualBruta:   r.inputRendaAnualBruta,
            inputInssPago:          r.inputInssPago,
            inputDespesasMedicas:   r.inputDespesasMedicas,
            inputDespesasInstrucao: r.inputDespesasInstrucao,
            inputPensaoAlimenticia: r.inputPensaoAlimenticia,
            inputDependentes:       r.inputDependentes,
            inputAporteAnualPGBL:   r.inputAporteAnualPGBL,
            inputIrRetidoFonte:     r.inputIrRetidoFonte,
