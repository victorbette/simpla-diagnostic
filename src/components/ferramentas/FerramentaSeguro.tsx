    ...
    try {
      ...
      await onResultadosChange?.({
        ...
        seguro: {
          ...
          criticalIllnessGap:      Math.max(0, calc.capitalDoencaGraveEfetivo - data.seguroDoencasGravesAtual),
          criticalIllnessCoverage: Math.min(calc.capitalDoencaGraveEfetivo, data.seguroDoencasGravesAtual),
          totalContinuoFamilia:      calc.totalContinuo,
          totalFilhos:               calc.totalFilhos,
          saldoPrevidencia:          calc.saldoPrevidencia,
          capitalInvalidezEfetivo:   calc.capitalInvalidezEfetivo,
          capitalDoencaGraveEfetivo: calc.capitalDoencaGraveEfetivo,
          seguroDoencasGravesAtual:  data.seguroDoencasGravesAtual,
